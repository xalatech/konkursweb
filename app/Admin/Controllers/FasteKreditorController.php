...
use App\FasteKreditor;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class FasteKreditorController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'App\FasteKreditor';
    ...
    {
        $grid = new Grid(new FasteKreditor());
    ...
    {
        $show = new Show(FasteKreditor::findOrFail($id));
    ...
    {
        $form = new Form(new FasteKreditor());
