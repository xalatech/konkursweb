                ...
                <div class="card-body">
                    <form action="{{ route('boinfo.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="navn" type="text" class="form-control @error('debitor') is-invalid @enderror" name="debitor" value="{{ old('debitor') }}" required autocomplete="debitor">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="saksnummer" type="text" class="form-control @error('saksnummer') is-invalid @enderror" name="saksnummer" value="{{ old('saksnummer') }}" required autocomplete="saksnummer">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kommune_id" type="text" class="form-control @error('kommune_id') is-invalid @enderror" name="kommune_id" value="{{ old('kommune_id') }}" required autocomplete="kommune_id">
